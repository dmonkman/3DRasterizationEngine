...
class RasterEngine3D{
	...
	// function Render(){
		...
		// var grd = ctx.createLinearGradient(cvsWidth/2, cvsHeight, cvsWidth/2, 0);
		...
		/*
		var grd = ctx.createLinearGradient(cvsWidth/2, cvsHeight/2, cvsWidth/2, cvsHeight);
		grd.addColorStop(1, '#0000FF');
		grd.addColorStop(0, "#4444EE");
		ctx.fillStyle = grd;
		ctx.fillRect(0, cvsHeight/2, cvsWidth, cvsHeight);*/

		// Draw the x,y,z axis
		//ctx.strokeStyle = "#FF0000";
		//camera.drawLine(new Vec3f(0, 0, 0), new Vec3f(50000, 0, 0));
		//ctx.strokeStyle = "#00FF00";
		//camera.drawLine(new Vec3f(0, 0, 0), new Vec3f(0, 50000, 0));
		//ctx.strokeStyle = "#0000FF";
		//camera.drawLine(new Vec3f(0, 0, 0), new Vec3f(0, 0, 50000));
		//ctx.strokeStyle = "#FFFFFF";
	...
	main(){
		...
		setTimeout(this.main, 60);
		//setTimeout(main, tickTime-(performance.now()-tTickStart));
	};

}

let myProgram : RasterEngine3D = new RasterEngine3D();
...
// 	var camera = new Camera([0, 2, -10], [0, 0, 1], [0, 1, 0]);
...
// 			camera.direction.rotate_origin(2*Math.acos(Q.w), new Vec3f(Q.x, Q.y, Q.z))
// 			camera.up.rotate_origin(2*Math.acos(Q.w), new Vec3f(Q.x, Q.y, Q.z))
// 			camera.right.rotate_origin(2*Math.acos(Q.w), new Vec3f(Q.x, Q.y, Q.z))
